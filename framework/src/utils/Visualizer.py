    ...
    def vis(self, idx, iter, gt_depth, gt_color, c2w_or_camera_tensor, c,
        ...
        with torch.no_grad():
            ...
            if (idx % self.freq == 0) and (iter % self.inside_freq == 0):
                ...
                color_residual = color_residual.sum(axis=-1)
                ...
                _im=axs[0, 2].imshow(depth_residual, cmap="viridis", vmin=0, vmax=0.1)
                ...
                _im=axs[1, 2].imshow(color_residual, cmap="plasma", vmin=0, vmax=0.5)
                _ax=axs[1, 2]
                ...
                plt.savefig(
                    f'{self.vis_dir}/{idx:05d}_{iter:04d}.png', bbox_inches='tight', pad_inches=0.1)
